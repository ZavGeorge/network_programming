...
После того как был выполнен вход в учетную запись p4 виртуальной машины, была выволнена настройка базовой переадресации.
...
После изменения скрипта была выполнена его работоспособность: с h1 был отправлен пакет на h2 с туннелированием.
...
Таким образом, была выполнена настройка базовой переадресации и туннелирования с помощью языка p4, познакомились с инструментом Vagrant, благодаря которому выполнено создание виртуальной машины.
